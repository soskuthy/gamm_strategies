...
#ggplot(dat, aes(x=measurement.no, y=f2, group=traj, col=group)) + geom_line(alpha=0.1) + facet_wrap(~ speaker)
#ggplot(dat, aes(x=measurement.no, y=f2, col=group)) + geom_smooth() + facet_wrap(~ speaker)
